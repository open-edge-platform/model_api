...
- Model creator: [getitune (Intel)](https://github.com/open-edge-platform/training_extensions)
- Original model: [<<model_full_name>>](<<docs>>)

## Description

This is a [getitune](https://github.com/open-edge-platform/training_extensions) version of [<<model_full_name>>](<<docs>>) model converted to the [OpenVINO™ IR](https://docs.openvino.ai/2026/documentation/openvino-ir-format.html) (Intermediate Representation) format with weights compressed to FP16.
...
# 1. Load model
model = Model.from_pretrained("OpenVINO/<<model_short_name>>-fp16-ov")
